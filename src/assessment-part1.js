...
String.prototype.grammarPolice = function() {
  var strArr = this.split(" ").map( (v) => { return v[0].toUpperCase() + v.slice(1).toLowerCase()})
  return strArr.join(" ")
}
// console.log("Strangely-Capitalized Strings That Offend The Internet".grammarPolice());
